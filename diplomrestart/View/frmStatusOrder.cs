...
namespace diplomrestart.View
{
    public partial class frmStatusOrder : Form
    {
        ...
        public void GetData()
        {
            string qry = "Select oid, p.pname,c.tname,ocount, p.pcost from OrderP o inner join Product p on p.pid = o.oprovider inner join provider c on c.tid = p.pprovider where oname like '%" + txtSearch.Text+"%' ";
